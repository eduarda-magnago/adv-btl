  ...
  return (
    <main className="bg-[#f5f3ee] min-h-screen">
      ...
      <section className="px-12">
        ...
        <p className="font-[Lora] text-[30px] font-normal text-[#0A0A0A] max-w-[500px] leading-relaxed mb-12">
          Atuação especializada em direito penal, com foco em estratégia, técnica e dedicação absoluta à defesa dos nossos clientes
        </p>

        <button className="flex items-center gap-4 font-[Tenor_Sans] text-[35px] text-[#182443] bg-transparent border border-[#182443] rounded px-8 py-3 cursor-pointer">
          Entre em contato
