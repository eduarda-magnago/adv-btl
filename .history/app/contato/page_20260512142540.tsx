        ...
        <div className="max-w-[700px] mx-auto">
          ...
          <div className="flex flex-col gap-6">
            <div className="flex flex-col md:flex-row gap-6">
              <div className="flex flex-col gap-1 flex-1">
                ...
                <input
                  ...
                  className="bg-white rounded-full px-4 py-3 outline-none border border-[#182443] text-[14px] font-[Tenor_Sans] [&:-webkit-autofill]:![box-shadow:0_0_0_1000px_white_inset]"
                />
              </div>
              <div className="flex flex-col gap-1 flex-1">
            ...
            <div className="flex items-center justify-between gap-2">
              <div className="text-[13px] font-[Tenor_Sans]">
                {status === "ok" && (
                  <p className="text-green-700">Mensagem enviada com sucesso!</p>
                )}
                {status === "erro" && (
                  <p className="text-red-600">Preencha todos os campos e tente novamente.</p>
                )}
              </div>
              <button
                onClick={handleEnviar}
                disabled={status === "loading"}
                className="bg-[#53707F] text-white font-[Tenor_Sans] text-[14px] px-8 py-3 rounded-[15px] cursor-pointer disabled:opacity-60 shrink-0"
              >
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="bg-white/50 backdrop-blur-sm rounded-[20px] px-15 py-8 w-[90%] md:w-[550px] text-center">
            ...
            <p className="font-[Tenor_Sans] text-black text-[13px] leading-relaxed">
              Atuação em todas as instâncias, com foco em resultados e na proteção dos direitos dos nossos clientes,
            </p>
          </div>
        </div>
      </section>
