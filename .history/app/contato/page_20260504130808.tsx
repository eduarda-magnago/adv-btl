      ...
      <section className="bg-[#DCDCDC] px-6 md:px-20 py-16">
        <div className="max-w-[700px] mx-auto">
            ...
            <div className="flex flex-col md:flex-row gap-6">
                ...
                <input type="text" className="bg-white rounded-full px-4 py-3 outline-none border-none text-[14px] font-[Tenor_Sans]"/>
                </div>

                <div className="flex flex-col gap-1 flex-1">
                <label className="font-[Tenor_Sans] text-[#182443] text-[14px]">E-mail</label>
                <input type="email" className="bg-white rounded-full px-4 py-3 outline-none border-none text-[14px] font-[Tenor_Sans]"
                />
                </div>
            </div>
            ...
            <div className="flex flex-col gap-1">
                ...
                <textarea rows={5} className="bg-white rounded-[16px] px-4 py-3 outline-none border-none text-[14px] font-[Tenor_Sans] resize-none"
                />
            </div>

            <div className="flex justify-end">
                <button className="bg-[#53707F] text-white font-[Tenor_Sans] text-[14px] px-8 py-3 rounded-full cursor-pointer">
                Enviar
                </button>
            </div>
            </div>
