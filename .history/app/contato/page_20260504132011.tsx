  ...
  return (
    <main className="bg-[#f8f8f8] min-h-screen overflow-x-hidden">
      ...
      <section className="relative w-full h-[400px]">
        ...
        />
        <div className="absolute inset-0 flex items-center justify-center pr-160">
          <div className="bg-white/50 backdrop-blur-sm rounded-[20px] px-10 py-8 w-[340px] text-center">
