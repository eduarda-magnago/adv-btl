  ...
  return (
    <main className="bg-[#f8f8f8] min-h-screen overflow-x-hidden">
      ...
      <section className="relative w-full h-[400px]">
        <Image src="/img/foto-es.png" alt="Espírito Santo" fill className="object-cover"
        />
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="bg-white/50 backdrop-blur-sm rounded-[20px] px-10 py-8 max-w-[320px] text-center">
