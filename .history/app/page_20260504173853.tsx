  ...
  <Header /> 
    <section className="px-6 pt-8 md:px-12"> 
      ...
      <section id="atuacoes" className="bg-[#ffffff] px-10 py-12 md:px-12 md:py-16 lg:px-20 text-center">
        ...
        <p className="font-[Tenor_Sans] text-black text-[13px] md:text-[16px] leading-relaxed max-w-[800px] mb-10 mx-auto text-justify">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-[800px] mx-auto cursor-pointer">
          ...
          <div
              key={index}
              className="bg-[#fdfdfd] rounded-[20px] border border-[#cccccc] px-6 py-3 flex items-center gap-3"
          >
              <Image src="/img/check-azul.png" alt="check" width={24} height={24} />
              <span className="font-[Tenor_Sans] text-[#141414] text-[14px]">{item}</span>
          </div>
          ))}
      </div>
      </section>
