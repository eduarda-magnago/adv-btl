...
export default function Home() {
  ...
  return (
    <main className="bg-[#f8f8f8] min-h-screen overflow-x-hidden">
      ...
      <section className="relative px-6 pt-8 md:px-12 min-h-screen">
  <Image
    src="/img/sua-imagem.png"
    alt=""
    fill
    className="object-cover object-center z-0"
    priority
  />
  <div className="absolute inset-0 bg-black/30 z-10" /> {/* overlay opcional para legibilidade */}

  <h1 className="relative z-20 font-[Lora] text-[32px] md:text-[50px] font-normal text-[#17445B] leading-tight max-w-[600px] mb-6 md:mb-8">
    Advocacia criminal com propósito e precisão
  </h1>

  <p className="relative z-20 font-[Lora] text-[16px] md:text-[25px] font-normal text-[#0A0A0A] max-w-[700px] leading-relaxed mb-8 md:mb-12">
    Atuação especializada em direito penal, com foco em estratégia, técnica e dedicação absoluta à defesa dos nossos clientes.
  </p>

  <Link href="/contato">
    <button className="relative z-20 flex items-center gap-3 md:gap-4 font-[Tenor_Sans] text-[16px] md:text-[20px] text-[#182443] bg-transparent border border-[#182443] rounded-[25px] px-6 md:px-8 py-3 cursor-pointer">
      Entre em contato
