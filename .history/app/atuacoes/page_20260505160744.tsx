    ...
    <div className="overflow-hidden rounded-[30px]">
      ...
      <div
        ...
        style={{
          ...
          opacity: open ? 1 : 0,
          transition: open
            ? "max-height 0.4s cubic-bezier(0.25, 0.46, 0.45, 0.94), opacity 0.3s ease 0.05s"
            : "max-height 0.4s cubic-bezier(0.25, 0.46, 0.45, 0.94), opacity 0.2s ease",
        }}
        className="overflow-hidden"
      >
        <div className="bg-[#aa1a1a] px-6 pt-5 pb-6">
    ...
    <main className="bg-[#f8f8f8] min-h-screen overflow-x-hidden">
      ...
      <section className="relative px-6 py-12 md:px-12 md:py-18 text-center overflow-hidden mb-6 md:mb-10">
        ...
        <p className="font-[Lora] text-[14px] md:text-[18px] text-[#0A0A0A] max-w-[600px] mx-auto leading-relaxed mb-8 md:mb-10">
          Conheça nossas áreas de atuação e como trabalhamos para oferecer soluções jurídicas estratégicas, alinhadas às necessidades de cada cliente.
        </p>
        <button>
      ...
      >
        ...
        <p className="font-[Tenor_Sans] text-white text-[12px] md:text-[14px]">
          Nossa expertise aplicada na prática do direito, com foco em resultados e segurança jurídica.
        </p>
      </section>
