...
export default function Home() {
  ...
  return (
    ...
    <div
      className="relative min-h-screenbg-right"
      style={{ backgroundImage: "url('/img/hero.png')" }}
    >
      
      {/* Overlay (opcional, melhora MUITO o visual) */}
      <div className="absolute inset-0 bg-gradient-to-r from-[#f8f8f6]/90 via-[#f8f8f6]/70 to-transparent"></div>

      <div className="relative z-10">
        <Header />

        <section className="px-6 pt-8 md:px-12">
          <h1 className="font-[Lora] text-[32px] md:text-[50px] text-[#17445B] max-w-[600px] mb-6 md:mb-8">
            Advocacia criminal com propósito e precisão
          </h1>

          <p className="font-[Lora] text-[16px] md:text-[25px] text-[#0A0A0A] max-w-[700px] mb-8 md:mb-12">
            Atuação especializada em direito penal, com foco em estratégia, técnica e dedicação absoluta à defesa dos nossos clientes.
          </p>

          <Link href="/contato">
            <button className="flex items-center gap-3 md:gap-4 text-[16px] md:text-[20px] text-[#182443] border border-[#182443] rounded-[25px] px-6 md:px-8 py-3">
              Entre em contato
            </button>
          </Link>
        </section>
