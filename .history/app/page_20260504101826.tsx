...
export default function Home() {
  return (
    <main className="bg-[#f8f8f8] min-h-screen">
      <header className="flex justify-between items-center px-40 py-2">
        <Image className="cursor-pointer" src="/img/bertolini-logo.png" alt="Bertolini Da Rós Advocacia" width={150} height={80}/>
