    ...
    <section className="px-6 pt-8 md:px-12"> 
      ...
      {expanded && (
        <>
          ...
          <p className="font-[Tenor_Sans] text-black text-[13px] md:text-[16px] leading-relaxed max-w-[800px] mb-6 mx-auto text-justify">
            <b>Direito Penal Econômico: Atuação em casos que envolvem crimes contra a ordem econômica e financeira, como lavagem de dinheiro, crimes tributários, corrupção e fraudes corporativas. Uma área que exige domínio técnico interdisciplinar, aliando o Direito Penal ao universo empresarial e regulatório.
          </p>
          <p className="font-[Tenor_Sans] text-black text-[13px] md:text-[16px] leading-relaxed max-w-[800px] mb-6 mx-auto text-justify">
