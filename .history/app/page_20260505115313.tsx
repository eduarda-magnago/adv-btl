    ...
    >
      ...
      <div className="relative z-10">
        ...
        <section className="px-6 pt-8 md:px-12">
          ...
          <Link href="/contato">
            <button className="cursor-pointer flex items-center gap-3 md:gap-4 text-[16px] md:text-[20px] text-[#182443] border border-[#182443] rounded-[25px] px-6 md:px-8 py-3">
              Entre em contato
            </button>
          </Link>
        </section>
