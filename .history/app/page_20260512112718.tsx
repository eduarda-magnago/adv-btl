...
{/* Mobile: imagem atrás do hero apenas */}
<div className="md:hidden absolute top-0 left-0 w-full h-[420px] z-0">
  <Image
    src="/img/praia.png"
    alt="Vitória ES"
    fill
  ...
  />
  <div className="absolute inset-0 bg-gradient-to-b from-[#f8f8f8]/80 via-[#f8f8f8]/60 to-[#f8f8f8]" />
</div>
