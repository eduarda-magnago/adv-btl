...
export default function Home() {
  ...
  return (
    <main className="bg-[#f8f8f8] min-h-screen overflow-x-hidden relative">
      ...
      {/* IMAGEM SOMENTE DO HERO */}
      <div className="absolute top-0 right-0 w-[55%] h-[100vh] hidden md:block z-0">
        <Image
          src="/img/vitoria.png"
          alt="Vitória ES"
          fill
      ...
      <div className="relative z-10">
        ...
        <section className="px-6 pt-8 md:px-12 min-h-[80vh] flex flex-col justify-center">
