  ...
  return (
    <main className="bg-[#f8f8f8] min-h-screen">
      <header className="flex justify-between items-center px-12 py-6">
        <Image className="cursor-pointer" src="/img/logo-bertolini.png" alt="Bertolini Da Rós Advocacia" width={300} height={80}  style={{height: "auto"}}/>

        <nav className="flex gap-10 [&>a]:font-[Tenor_Sans] [&>a]:text-[15px] [&>a]:text-black [&>a]:tracking-widest [&>a]:no-underline">
          <a href="#">MISSÃO</a>
          <a href="#">HISTÓRIA</a>
          <a href="#">SERVIÇOS</a>
          <a href="#">ARTIGOS</a>
