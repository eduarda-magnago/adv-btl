...
export default function Home() {
  return (
    <main className="bg-[#f8f8f8] min-h-screen">
      ...
      <section id="atuacoes" className="bg-[#ffffff] px-6 py-12 md:px-12 md:py-16 lg:px-20 text-center">
      ...
       
        <h2 className="font-[Tenor_Sans] text-black text-[16px] md:text-[20px] tracking-widest mb-4 md:mb-10">ATUAÇÕES</h2>
       
