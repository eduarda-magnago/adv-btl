...
@import url('https://fonts.googleapis.com/css2?family=Tenor+Sans&family=Lora&display=swap');

export default function Home() {
  return (
    <main className="bg-[#f5f3ee] min-h-screen">
      <header className="flex justify-between items-center px-16 py-8">
        <Image src="/logo.png" alt="Bertolini Da Rós Advocacia" width={160} height={80} />
