...
export default function Home() {
  ...
  return (
    <main className="bg-[#f8f8f8] min-h-screen overflow-x-hidden relative">
      ...
      {/* Foto — só aparece no desktop */}
      <div className="hidden md:block absolute top-0 right-0 w-[55%] h-[100vh] z-0">
        <Image
          src="/img/vitoriaa.png"
          alt="Vitória ES"
          fill
          priority
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-[#f8f8f8] via-[#f8f8f8]/20 to-transparent" />
      </div>
