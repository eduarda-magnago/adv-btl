  ...
  return (
    <main className="bg-[#f8f8f8] min-h-screen overflow-x-hidden">
      ...
      <section className="px-6 pt-8 md:px-12">
        ...
        <lINK className="flex items-center gap-3 md:gap-4 font-[Tenor_Sans] text-[16px] md:text-[20px] text-[#182443] bg-transparent border border-[#182443] rounded-[25px] px-6 md:px-8 py-3 cursor-pointer">
          Entre em contato
