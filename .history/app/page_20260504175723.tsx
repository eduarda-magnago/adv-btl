...
export default function Home() { 
  ...
  <Header /> 
    <section className="px-6 pt-8 md:px-12"> 
      ...
      <section className="bg-[#53707F] px-10 py-12 md:px-16 md:py-16 lg:px-20 mt-10 md:mt-16"> 
      ...
      {expanded && (
        <>
          <p className="font-[Tenor_Sans] text-black text-[13px] md:text-[16px] leading-relaxed max-w-[800px] mb-6 mx-auto text-justify">
            <b>Leia por Definição:</b>
          </p>
          <p className="font-[Tenor_Sans] text-black text-[13px] md:text-[16px] leading-relaxed max-w-[800px] mb-6 mx-auto text-justify">
            Direito Penal: Defesa em todas as fases do processo penal, do inquérito à execução da pena. O escritório atua em crimes contra a honra, contra a dignidade sexual, contra o patrimônio, contra a vida e nas demais espécies delitivas previstas na legislação penal, sempre com compromisso na proteção das garantias fundamentais de cada cliente, independentemente da natureza ou complexidade do caso.
          </p>
          <p className="font-[Tenor_Sans] text-black text-[13px] md:text-[16px] leading-relaxed max-w-[800px] mb-6 mx-auto text-justify">
            Direito Penal Econômico: Atuação em casos que envolvem crimes contra a ordem econômica e financeira, como lavagem de dinheiro, crimes tributários, corrupção e fraudes corporativas. Uma área que exige domínio técnico interdisciplinar, aliando o Direito Penal ao universo empresarial e regulatório.
          </p>
          <p className="font-[Tenor_Sans] text-black text-[13px] md:text-[16px] leading-relaxed max-w-[800px] mb-6 mx-auto text-justify">
            <b>Direito Penal Digital: Assessoria e defesa em condutas praticadas no ambiente virtual, como estelionato digital, crimes contra a honra, invasão de dispositivos, crimes envolvendo inteligência artificial, entre outras. Uma frente de atuação cada vez mais relevante diante da expansão das relações humanas no espaço digital.
          </p>
        </>
      )}
    </section>
      ...
      <section id="artigos" className="bg-[#F0F0F0] px-6 py-12 md:px-12 md:py-16 lg:px-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 max-w-[900px] mx-auto">
          <Link href="https://www.conjur.com.br/2025-nov-28/as-implicacoes-de-infidelidade-patrimonial-no-caso-do-banco-master/" target="_blank" className="bg-[#53707F] rounded-[20px] p-6 md:p-8 cursor-pointer">
          ...
          <Link href="https://www.conjur.com.br/2025-jan-31/o-lancamento-definitivo-do-credito-tributario-como-condicao-objetiva-de-punibilidade-e-o-principio-da-independencia-de-instancias/" target="_blank" className="bg-[#53707F] rounded-[20px] p-6 md:p-8 cursor-pointer">
            <h3 className="font-[Tenor_Sans] font-semibold text-white text-[13px] md:text-[14px] tracking-widest mb-3 md:mb-4 text-center">
              ARTIGO 02
            </h3>
            <h3 className="font-[Tenor_Sans] text-white text-[13px] md:text-[14px] tracking-widest mb-3 md:mb-4 text-center">
          ...
          <Link href="https://www.migalhas.com.br/depeso/403681/o-dilema-das-representacoes-fiscais-para-fins-penais-e-voto-no-carf" target="_blank" className="bg-[#53707F] rounded-[20px] p-6 md:p-8 cursor-pointer sm:col-span-2 md:col-span-1">
            <h3 className="font-[Tenor_Sans] font-semibold text-white text-[13px] md:text-[14px] tracking-widest mb-3 md:mb-4 text-center">
              ARTIGO 03
            </h3>
