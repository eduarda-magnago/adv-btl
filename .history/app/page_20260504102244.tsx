  ...
  return (
    <main className="bg-[#f8f8f8] min-h-screen">
      ...
      <section className="px-12 pt-8">
        ...
        <button className="flex items-center gap-4 font-[Tenor_Sans] text-[25px] text-[#182443] bg-transparent border border-[#182443] rounded-[25px] px-8 py-3 cursor-pointer">
          Entre em contato
