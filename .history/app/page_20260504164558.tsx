...
export default function Home() {
  return (
    <main className="bg-[#f8f8f8] min-h-screen overflow-x-hidden">
      ...
      <section className="relative px-6 pt-8 md:px-12 flex items-end justify-between">
  
  <div className="max-w-[600px]">
    <h1 className="font-[Lora] text-[32px] md:text-[50px] text-[#17445B] mb-6">
      Advocacia criminal com propósito e precisão
    </h1>

    <p className="font-[Lora] text-[16px] md:text-[25px] mb-8">
      Atuação especializada em direito penal...
    </p>

    <Link href="/contato">
      <button className="flex items-center gap-3 border rounded-[25px] px-6 py-3">
        Entre em contato
      </button>
    </Link>
  </div>
  ...
  <Image
    src="/img/terceira-ponte.png"
    alt="Imagem da terceira ponte"
    width={700}
    height={500}
