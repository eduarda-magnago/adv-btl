...
export default function Termos() {
  return (
    <main className="bg-[#f8f8f8] min-h-screen">
      ...
      <section className="relative px-12 py-10 text-center overflow-hidden mb-10">
      ...
      <section className="px-20 py-16 max-w-[900px] items-center mx-auto">
        ...
        <ol className="font-[Tenor_Sans] text-black text-[15px] leading-relaxed space-y-4 list-decimal list-inside">
          <li>
        ...
        <p className="font-[Tenor_Sans] text-black text-[18px] mb-4">
          Bertolini da Rós Advocacia — OAB/ES 41.885
        </p>
