  ...
  return (
    <main className="bg-[#f8f8f8] min-h-screen">
      ...
      <section className="relative px-12 py-10 text-center overflow-hidden mb-10">
        ...
        <button className="flex items-centerrelative z-10  gap-3 font-[Tenor_Sans] text-[16px] text-white bg-[#53707F] rounded-[20px] px-8 py-3 mx-auto cursor-pointer">
          Alguma dúvida?
      ...
      <section className="px-20 py-16 max-w-[900px] mx-auto">
