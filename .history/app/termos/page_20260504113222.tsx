...
export default function Termos() {
  return (
    <main className="bg-[#f8f8f8] min-h-screen">
      ...
      <section className="relative px-12 py-20 text-center overflow-hidden">
        <div className="absolute inset-0 flex items-center justify-center opacity-10 pointer-events-none">
          <Image src="/img/bertolini-logo.png" alt="" width={400} height={400} />
        </div>
        ...
        <button className="flex items-center gap-3 font-[Tenor_Sans] text-[16px] text-white bg-[#53707F] rounded-[25px] px-8 py-3 mx-auto cursor-pointer">
          Alguma dúvida?
          <Image src="/img/seta-botao.png" alt="ícone" width={24} height={24} />
        </button>
      </section>
