      ...
      <section id="atuacoes" className="bg-[#ffffff] px-10 py-12 md:px-12 md:py-16 lg:px-20 text-center">
        <div className="flex justify-end mb-6 md:mb-4">
          <button
            ...
            className="font-[Tenor_Sans] text-black text-[14px] md:text-[16px] tracking-widest hover:opacity-70"
          >
        ...
        <p className="font-[Tenor_Sans] text-black text-[13px] md:text-[16px] leading-relaxed max-w-[800px] mb-6 mx-auto text-justify">
          O escritório atua na defesa criminal em toda a sua extensão...
        </p>
        <p className="font-[Tenor_Sans] text-black text-[13px] md:text-[16px] leading-relaxed max-w-[800px] mb-6 mx-auto text-justify">
          A atuação alcança ainda o Direito Penal Digital...
        </p>

        {expanded && (
          <>
            <p className="font-[Tenor_Sans] text-black text-[13px] md:text-[16px] leading-relaxed max-w-[800px] mb-6 mx-auto text-justify">
              <b>Direito Penal:</b> Defesa em todas as fases...
            </p>
            <p className="font-[Tenor_Sans] text-black text-[13px] md:text-[16px] leading-relaxed max-w-[800px] mb-6 mx-auto text-justify">
              <b>Direito Penal Econômico:</b> Atuação em casos...
            </p>
            <p className="font-[Tenor_Sans] text-black text-[13px] md:text-[16px] leading-relaxed max-w-[800px] mb-6 mx-auto text-justify">
              <b>Direito Penal Digital:</b> Assessoria e defesa...
            </p>
          </>
        )}
      </section>
