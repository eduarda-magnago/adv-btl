...
export default function Home() {
  ...
  {/* Mobile: NOVO — só atrás do hero */}
  <div className="md:hidden absolute top-0 left-0 w-full h-[400px] z-0">
    <Image
      src="/img/praia.png"
      alt="Vitória ES"
      fill
    ...
    />
    <div className="absolute inset-0 bg-gradient-to-b from-[#f8f8f8]/70 via-[#f8f8f8]/50 to-[#f8f8f8]" />
  </div>
  </div>
