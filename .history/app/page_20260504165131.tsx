    ...
    <section className="px-6 pt-8 md:px-12"> 
      ...
      <section className="bg-[#53707F] px-10 py-12 md:px-16 md:py-16 lg:px-20 mt-10 md:mt-16"> 
        <p className="font-[Tenor_Sans] text-white text-[14px] md:text-[18px] lg:text-[20px] leading-relaxed max-w-[900px] mx-auto text-center italic"> 
          "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat." </p> </section>
