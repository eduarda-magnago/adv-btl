...
export default function Home() {
  ...
  <div className="absolute top-0 right-0 w-full md:w-[55%] h-[100vh] z-0">
    <Image
      src="/img/vitoria.png"
      alt="Vitória ES"
      fill
    ...
    {/* FADE LATERAL */}
    <div className="absolute inset-0 bg-gradient-to-r from-[#f8f8f8] via-[#f8f8f8]/45 to-transparent" />
  </div>
