...
export default function Home() { return ( <main className="bg-[#f8f8f8] min-h-screen overflow-x-hidden"> <Header /> <section className="px-6 pt-8 md:px-12"> <h1 className="font-[Lora] text-[32px] md:text-[50px] font-normal text-[#17445B] leading-tight max-w-[600px] mb-6 md:mb-8"> Advocacia criminal com propósito e precisão </h1> <p className="font-[Lora] text-[16px] md:text-[25px] font-normal text-[#0A0A0A] max-w-[700px] leading-relaxed mb-8 md:mb-12"> Atuação especializada em direito penal, com foco em estratégia, técnica e dedicação absoluta à defesa dos nossos clientes. </p> <Link href="/contato"> <button className="flex items-center gap-3 md:gap-4 font-[Tenor_Sans] text-[16px] md:text-[20px] text-[#182443] bg-transparent border border-[#182443] rounded-[25px] px-6 md:px-8 py-3 cursor-pointer"> Entre em contato <Image src="/img/seta-botao.png" alt="ícone" width={32} height={32}/> </button> </Link> <Image src="/img/terceira-ponte.png" alt="Imagem da terceira ponte" width={800} height={600} className="absolute right-0 bottom-0" /> </section> <section className="bg-[#53707F] px-10 py-12 md:px-16 md:py-16 lg:px-20 mt-10 md:mt-16"> <p className="font-[Tenor_Sans] text-white text-[14px] md:text-[18px] lg:text-[20px] leading-relaxed max-w-[900px] mx-auto text-center italic"> "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat." </p> </section>
