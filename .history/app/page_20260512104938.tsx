...
export default function Home() {
  ...
  return (
    <main className="bg-[#f8f8f8] min-h-screen overflow-hidden relative">
  <Header />

  {/* IMAGEM */}
  <div className="absolute top-0 right-0 w-[55%] h-screen">
    <img
      src="/img/vitoria.png"
      alt="Vitória ES"
    ...
    {/* FADE LATERAL */}
    <div className="absolute inset-0 bg-gradient-to-r from-[#f8f8f8] via-[#f8f8f8]/70 to-transparent" />
  </div>

  {/* CONTEÚDO */}
  <section className="relative z-10 px-6 pt-8 md:px-12 max-w-[900px]">
