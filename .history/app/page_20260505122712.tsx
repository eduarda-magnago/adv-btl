...
export default function Home() {
  ...
  return (
    <main className="bg-[#f8f8f8] min-h-screen overflow-x-hidden">
      ...
      >
        <p className="font-[Tenor_Sans] text-white text-[13px] md:text-[18px] lg:text-[18px] leading-relaxed max-w-[900px] mx-auto text-center italic">
          "O fim do Direito não é abolir nem restringir, mas preservar e ampliar a liberdade." <br></br>— John Locke
        </p>
      </section>
