    ...
    <main className="bg-[#f8f8f8] min-h-screen overflow-x-hidden">
      ...
      >
        ...
        <p className="font-[Tenor_Sans] text-white text-[12px] md:text-[14px]">
          Conheça os valores e a visão que guiam nossa atuação.
        </p>
      </section>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-[900px] mx-auto">
          <div className="bg-[#EBEBEB] rounded-[16px] overflow-hidden cursor-pointer transition-transform duration-300 hover:-translate-y-2 hover:shadow-xl">
            ...
            <p className="font-[Tenor_Sans] text-black text-[10px] leading-relaxed text-justify p-6">
              Atuamos com o compromisso inabalável de garantir que cada cliente receba uma defesa justa e tecnicamente fundamentada, respeitando os princípios constitucionais que regem o processo penal.
            </p>
          </div>
          ...
          <div className="bg-[#EBEBEB] rounded-[16px] overflow-hidden cursor-pointer transition-transform duration-300 hover:-translate-y-2 hover:shadow-xl">
            ...
            <p className="font-[Tenor_Sans] text-black text-[13px] leading-relaxed text-justify p-6">
              A relação com nossos clientes é pautada pela transparência, pelo sigilo profissional e pela conduta irrepreensível. Cada caso é tratado com a seriedade e a discrição que a advocacia criminal exige.
            </p>
          </div>
          ...
          <div className="bg-[#EBEBEB] rounded-[16px] overflow-hidden cursor-pointer transition-transform duration-300 hover:-translate-y-2 hover:shadow-xl">
            ...
            <p className="font-[Tenor_Sans] text-black text-[13px] leading-relaxed text-justify p-6">
              Dedicação integral a cada caso, do primeiro contato à decisão final. Acreditamos que uma defesa eficaz nasce do preparo constante e da atenção genuína às particularidades de cada cliente.
            </p>
          </div>
        </div>
      </section>
