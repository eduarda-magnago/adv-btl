...
export default function Historia() {
  return (
    <main className="bg-[#f8f8f8] min-h-screen overflow-x-hidden">
      ...
      <section className="bg-[#53707F] px-6 py-12 md:px-2 md:py-15 text-center">
      ...
      <section id="missao" className="bg-[#F0F0F0] px-10 py-12 md:px-12 md:py-16 lg:px-20 text-center">
        ...
        <p className="font-[Tenor_Sans] text-black text-[13px] md:text-[16px] leading-relaxed max-w-[800px] mx-auto text-justify">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Autem, tenetur error molestiae libero in, commodi doloremque corporis totam repellendus voluptates, culpa incidunt quaerat! Molestias velit officia impedit, repellat incidunt est?
        </p>
      </section>
      ...
      <section className="bg-[#ffffff] px-20 py-16 text-center">
        ...
        <section id="atuacoes" className="bg-[#F0F0F0] px-20 py-16 text-center">
            <h2 className="font-[Tenor_Sans] text-black text-[20px] tracking-widest mb-4">
                ATUAÇÕES
            </h2>
