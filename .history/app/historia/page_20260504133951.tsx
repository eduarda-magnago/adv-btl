  ...
  return (
    <main className="bg-[#f8f8f8] min-h-screen overflow-x-hidden">
      ...
      <section className="relative px-12 py-18 text-center overflow-hidden mb-10">
        ...
        <button>
            <a href="#atuacoes" className="flex items-center relative z-10 gap-3 font-[Tenor_Sans] text-[16px] text-white bg-[#53707F] rounded-[20px] px-8 py-3 mx-auto cursor-pointer">
                Especializações
