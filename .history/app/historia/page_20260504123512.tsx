  ...
  return (
    <main className="bg-[#f8f8f8] min-h-screen">
      ...
      <section className="bg-[#f8f8f8] px-20 py-16">
        <div className="flex items-start gap-12 max-w-[900px] mx-auto">
      ...
      <section className="bg-[#f8f8f8] px-20 py-16 text-center">
        ...
        <div className="grid grid-cols-3 gap-6 max-w-[900px] mx-auto">
            ...
            <div className="bg-[#EBEBEB] rounded-[16px] overflow-hidden">
            <div className="bg-[#53707F] px-6 py-3 flex items-center gap-3">
                <Image src="/img/icone-justica.png" alt="Justiça" width={24} height={24} />
                <h3 className="font-[Tenor_Sans] text-white text-[16px]">Justiça</h3>
            </div>
            <p className="font-[Tenor_Sans] text-black text-[13px] leading-relaxed text-left p-6">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
            </p>
            </div>
            ...
            <div className="bg-[#53707F] px-6 py-3 flex items-center gap-3">
                ...
                <h3 className="font-[Tenor_Sans] text-white text-[16px]">Ética</h3>
            </div>
            <p className="font-[Tenor_Sans] text-black text-[13px] leading-relaxed text-left p-6">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
            </p>
            ...
            <div className="bg-[#53707F] px-6 py-3 flex items-center gap-3">
                ...
                <h3 className="font-[Tenor_Sans] text-white text-[16px]">Compromisso</h3>
            </div>
            <p className="font-[Tenor_Sans] text-black text-[13px] leading-relaxed text-left p-6">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
            </p>
