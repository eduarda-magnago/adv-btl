  ...
  return (
    <main className="bg-[#f8f8f8] min-h-screen">
      ...
      <section className="bg-[#F0F0F0] px-20 py-16 text-center">
        ...
        <p className="font-[Tenor_Sans] text-black text-[16px] leading-relaxed max-w-[800px] mb-6 mx-auto">
        ...
        <p className="font-[Tenor_Sans] text-black text-[16px] leading-relaxed max-w-[800px] mx-auto">
      ...
      <section className="bg-[#F] px-20 py-16 text-center">
        <h2 className="font-[Tenor_Sans] text-black text-[20px] tracking-widest mb-10">ATUAÇÕES</h2>

        <p className="font-[Tenor_Sans] text-black text-[16px] leading-relaxed max-w-[800px] mb-6 mx-auto">
          O escritório atua na defesa criminal em toda a sua extensão, dos crimes comuns, como os praticados contra a pessoa, o patrimônio e com entorpecentes, aos delitos de maior complexidade no âmbito do Direito Penal Econômico, incluindo lavagem de capitais, crimes tributários, corrupção e ilícitos contra o sistema financeiro. A atuação alcança ainda o Direito Penal Digital, com defesa especializada em crimes cibernéticos, fraudes eletrônicas e demais ilícitos praticados no ambiente virtual, área que exige atualização constante e compreensão técnica aprofundada do meio digital.
        </p>
      </section>
