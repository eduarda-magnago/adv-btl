...
export default function Home() { 
  ...
  <h2 className="font-[Tenor_Sans] text-black text-[16px] md:text-[20px] tracking-widest mb-8 md:mb-12 text-center">
    ARTIGOS PUBLICADOS
  </h2>

  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 max-w-[900px] mx-auto">
    <Link
      href="https://www.conjur.com.br/2025-nov-28/..."
      target="_blank"
      className="bg-[#53707F] rounded-[20px] p-6 md:p-8 cursor-pointer
    ...
    <Link
      href="https://www.conjur.com.br/2025-jan-31/..."
      target="_blank"
      className="bg-[#53707F] rounded-[20px] p-6 md:p-8 cursor-pointer
                 transition-transform duration-300 ease-bounce
                 hover:-translate-y-3 hover:shadow-xl"
    ...
    <Link
      ...
      target="_blank"
      className="bg-[#53707F] rounded-[20px] p-6 md:p-8 cursor-pointer sm:col-span-2 md:col-span-1
                 transition-transform duration-300 ease-bounce
                 hover:-translate-y-3 hover:shadow-xl"
    >
      {/* conteúdo */}
