    ...
    <header className="relative">
      ...
      <div className="flex justify-between items-center px-6 py-6 md:px-12 md:py-10">
        ...
        <nav className="hidden md:flex gap-10">
          <div className="font-[Tenor_Sans] text-[15px] text-black tracking-widest no-underline flex gap-10 [&>a]:relative [&>a]:after:absolute [&>a]:after:bottom-0 [&>a]:after:left-0 [&>a]:after:h-[1.5px] [&>a]:after:w-0 [&>a]:after:bg-black [&>a]:after:transition-all [&>a]:after:duration-300 [&>a]:hover:after:w-full">
            <a href="/" className="after:w-full">INÍCIO</a>
