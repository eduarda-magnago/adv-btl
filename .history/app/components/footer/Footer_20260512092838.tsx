  ...
  return (
    <footer>
      <div className="bg-[#ffffff] px-6 py-6 md:px-10 md:py-8 flex flex-row justify-between items-center">
        <Link href="/">
          <div className="w-35 sm:w-[170px] md:w-[200px]">
        ...
        <div className="text-right">
          ...
          <p className="font-[Tenor_Sans] text-black text-[10px] sm:text-[12px] md:text-[14px] leading-relaxed max-w-[150px] sm:max-w-[220px] md:max-w-[280px]">
