    ...
    <footer>
      ...
      <div className="bg-[#53707F] px-20 py-4 flex justify-between items-center">
        <p className="font-[Tenor_Sans] text-white text-[12px]">
            Desenvolvido por <a href="https://eduardamagnago.com/" target="_blank" rel="noopener noreferrer" className="cursor-pointer hover:opacity-70 nounderline">EM Studio.</a>
        </p>
        <p className="font-[Tenor_Sans] text-white text-[12px]">
