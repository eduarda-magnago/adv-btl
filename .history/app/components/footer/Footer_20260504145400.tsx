...
export default function Footer() {
  return (
    <footer>
      <div className="bg-[#ffffff] px-6 py-6 md:px-10 md:py-8 flex flex-col items-center gap-6 md:flex-row md:justify-between md:items-center">
        <Link href="/">
        ...
        <div className="text-center md:text-left">
          <h3 className="font-[Tenor_Sans] text-black text-[15px] md:text-[18px] tracking-widest mb-2 md:mb-4">
            Endereço
          </h3>
          <p className="font-[Tenor_Sans] text-black text-[12px] md:text-[14px] leading-relaxed max-w-[260px] md:max-w-[280px]">
