...
export default function Home() {
  return (
    <main className="bg-[#f8f8f8] min-h-screen">
      ...
      <section className="bg-[#F0F0F0] px-20 py-16">
  <div className="flex justify-end mb-4">
  ...
  <h2 className="font-[Tenor_Sans] text-black text-[20px] tracking-widest mb-10 text-center">ARTIGOS PUBLICADOS</h2>

  <div className="grid grid-cols-3 gap-6 max-w-[900px] mx-auto">

    <div className="bg-[#53707F] rounded-[20px] p-8">
