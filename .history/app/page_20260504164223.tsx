      ...
      <section className="px-6 pt-8 md:px-12">
        ...
        <Link href="/contato">
          <button className="flex items-center gap-3 md:gap-4 font-[Tenor_Sans] text-[16px] md:text-[20px] text-[#182443] bg-transparent border border-[#182443] rounded-[25px] px-6 md:px-8 py-3 cursor-pointer">
            Entre em contato
            <Image src="/img/seta-botao.png" alt="ícone" width={32} height={32} className="absolute right-0 bottom-0" />
          </button>
        </Link>
        <Image src="/img/terceira-ponte.png" alt="Imagem da terceira ponte" width={800} height={600} />
      </section>
