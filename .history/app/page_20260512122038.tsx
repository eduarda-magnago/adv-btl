...
export default function Home() {
  ...
  return (
    <main className="bg-[#f8f8f8] min-h-screen overflow-x-hidden relative">
      <div className="hidden md:block absolute top-0 right-0 w-[65%] z-0" style={{ height: '100dvh', maxHeight: '800px' }}>
        <Image
          src="/img/praia.png"
          alt="Vitória ES"
          fill
      ...
      <div className="relative z-10 md:[min-height:100dvh]" style={{ maxHeight: '700px' }}>
        <Header />
