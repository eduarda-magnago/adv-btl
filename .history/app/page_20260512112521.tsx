...
export default function Home() {
  ...
  return (
    ...
    {/* Desktop: imagem à direita com gradiente horizontal */}
    <div className="hidden md:block absolute top-0 right-0 w-[65%] h-[100vh] z-0">
      <Image
        src="/img/praia.png"
        alt="Vitória ES"
        fill
    ...
    {/* Mobile: imagem de fundo full-width com gradiente vertical */}
    <div className="md:hidden absolute top-0 left-0 w-full h-[100vh] z-0">
      <Image
        src="/img/praia.png"
        alt="Vitória ES"
        fill
      ...
      />
      {/* Gradiente de cima para baixo: cobre o texto no topo e some no meio */}
      <div className="absolute inset-0 bg-gradient-to-b from-[#f8f8f8] from-[0%] via-[#f8f8f8]/75 via-[50%] to-[#f8f8f8]/30 to-[100%]" />
    </div>
