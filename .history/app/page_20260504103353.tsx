  ...
  return (
    <main className="bg-[#f8f8f8] min-h-screen">
      ...
      <section className="bg-[#F0F0F0] px-20 py-16 text-center">
        ...
        <p className="font-[Tenor_Sans] text-black text-[16px] leading-relaxed max-w-[800px] mb-6 text-center mx-auto">
        ...
        <p className="font-[Tenor_Sans] text-black text-[16px] leading-relaxed max-w-[800px] text-center mx-auto">
