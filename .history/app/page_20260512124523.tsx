...
export default function Home() {
  ...
  return (
    <main className="bg-[#f8f8f8] min-h-screen overflow-x-hidden relative">
      <div className="hidden md:block absolute top-0 right-0 w-[65%] z-0" style={{ height: '100dvh' }}>
        <Image
          src="/img/praia.png"
          alt="Vitória ES"
          fill
      ...
      <div className="relative z-10 md:h-[100dvh] md:flex md:flex-col md:justify-between md:py-16">
        <Header />

        <section className="px-6 pt-12 md:pt-16 md:px-12 relative z-10 pb-16 md:pb-24">
