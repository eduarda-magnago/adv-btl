  ...
  <Header /> 
    <section className="px-6 pt-8 md:px-12"> 
      ...
      {expanded && (
        <>
          <p className="font-[Tenor_Sans] text-black text-[13px] md:text-[16px] leading-relaxed max-w-[800px] mb-6 mx-auto text-justify">
            DIREITO PENAL:<br/> Defesa em todas as fases do processo penal, do inquérito à execução da pena. O escritório atua em crimes contra a honra, contra a dignidade sexual, contra o patrimônio, contra a vida e nas demais espécies delitivas previstas na legislação penal, sempre com compromisso na proteção das garantias fundamentais de cada cliente, independentemente da natureza ou complexidade do caso.
          </p>
          <p className="font-[Tenor_Sans] text-black text-[13px] md:text-[16px] leading-relaxed max-w-[800px] mb-6 mx-auto text-justify">
            DIREITO PENAL ECONÔMICO:<br/>  Atuação em casos que envolvem crimes contra a ordem econômica e financeira, como lavagem de dinheiro, crimes tributários, corrupção e fraudes corporativas. Uma área que exige domínio técnico interdisciplinar, aliando o Direito Penal ao universo empresarial e regulatório.
          </p>
          <p className="font-[Tenor_Sans] text-black text-[13px] md:text-[16px] leading-relaxed max-w-[800px] mb-6 mx-auto text-justify">
            DIREITO PENAL DIGITAL:<br/> Assessoria e defesa em condutas praticadas no ambiente virtual, como estelionato digital, crimes contra a honra, invasão de dispositivos, crimes envolvendo inteligência artificial, entre outras. Uma frente de atuação cada vez mais relevante diante da expansão das relações humanas no espaço digital.
          </p>
        </>
      )}
    </section>
